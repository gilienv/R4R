...
## A note on R and <code class="highlighter-rouge">.xlsx</code>

##### There are R packages that can read <code class="highlighter-rouge">.xls or .xlsx</code> files (as well as Google spreadsheets). It is even possible to access different worksheets in the <code class="highlighter-rouge">.xlsx</code> documents.</p>
...
##### NOTE: For more of a discussion on data formats and potential issues with commas within datasets see <a href="http://www.datacarpentry.org/spreadsheet-ecology-lesson/discuss/">the discussion page</a>.</p>
